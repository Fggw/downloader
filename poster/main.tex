...
\begin{figure}
\includegraphics[width=0.8\linewidth]{figures/inspection_map.png}
\caption{Spacial Visualization of Inspection Results}
\end{figure}
...
\begin{itemize}
\item Website: \href{http://}
\item Code: \href{http://github.com/fggw}{http://github.com/fggw}
\item Email: \{lfarewell, jgober, samuelgreen, jeremywelborn\}@college.harvard.edu
\end{itemize}
